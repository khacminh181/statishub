...
class OrganizationNotFoundError(StatishubException):
    ...
    def __init__(self, taxcode: str = None):
        # Store taxcode for internal logging but don't expose in message
        self.taxcode = taxcode
        # Generic message to prevent information disclosure
        super().__init__("Organization not found", status_code=404)
...
class BruteForceProtectionError(StatishubException):
    """Raised when too many failed authentication attempts detected."""
